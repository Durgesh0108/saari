...
//     { value: "user", label: "Vendor" },
//     { value: "color", label: "Color" },
//     { value: "size", label: "Size" },
//     { value: "material", label: "Material" },
//     { value: "pattern", label: "Pattern" },
//     { value: "personCategory", label: "Person Category" },
//     { value: "productType", label: "Product Category" },
//   ]);
...
//                       <Link href={`/admin/website/products/${product.id}`}>
...
//                         ? product.price
//                         : col.value === "offer_price" && product.offer_price
//                         ? product.offer_price
