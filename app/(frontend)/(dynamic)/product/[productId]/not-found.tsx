...
//     //       The Product You are Look For is not Available
//     //     </p>
//     //     <Link
//     //       href="/"
...
//             </div>
//             <Link className="mb-20 md:mb-0" href={"/"}>
          ...
          <div className="w-full md:w-1/2 text-center">
            ...
            >
              ...
              <g id="OBJECTS">
                ...
                <path
                  className="st5"
                  d="M155.84 131.97L177 94.68a6.857 6.857 0 0 1 6.74-3.42c3.75.44 6.44 3.83 6 7.58l-4.4 37.72.19.02c2.6.3 4.46 2.66 4.16 5.25a4.74 4.74 0 0 1-5.25 4.16l-.19-.02-.8 6.87c-.33 2.81-2.87 4.82-5.67 4.49-2.81-.33-4.82-2.87-4.49-5.67l.8-6.87-15.24-1.78c-2.6-.3-4.47-2.66-4.16-5.26l.4-3.46c.09-.82.34-1.61.75-2.32zm19.4 2.79l2.73-23.39c.02-.16-.2-.23-.28-.09l-12.5 22.06c-.22.39.03.88.47.93l8.89 1.04c.34.04.65-.21.69-.55zM249.23 142.87l21.16-37.29a6.857 6.857 0 0 1 6.74-3.42c3.75.44 6.44 3.83 6 7.58l-4.4 37.72.19.02c2.6.3 4.46 2.66 4.16 5.25a4.74 4.74 0 0 1-5.25 4.16l-.19-.02-.8 6.87c-.33 2.81-2.87 4.82-5.67 4.49-2.81-.33-4.82-2.87-4.49-5.67l.8-6.87-15.24-1.78c-2.6-.3-4.47-2.66-4.16-5.26l.4-3.46c.09-.82.35-1.6.75-2.32zm19.41 2.79l2.73-23.39c.02-.16-.2-.23-.28-.09l-12.5 22.06c-.22.39.03.88.47.93l8.89 1.04c.34.04.65-.21.69-.55zM207.25 110.04c1.23-10.57-6.17-20.24-16.73-21.48-10.57-1.23-20.24 6.17-21.48 16.73-1.23 10.57 6.17 20.24 16.73 21.48 10.57 1.23 20.24-6.17 21.48-16.73z"
                />
                <circle className="st6" cx="168.99" cy="94.52" r="6.6" />
                <circle className="st6" cx="246.1" cy="103.38" r="6.6" />
                <path
                  className="st7"
                  d="M171.56 63.93c-1.86-.22-3.5 1.09-3.72 2.95l-4.41 37.73c-.22 1.86 1.09 3.5 2.95 3.72l37.73 4.41c1.86.22 3.5-1.09 3.72-2.95l4.41-37.73c.22-1.86-1.09-3.5-2.95-3.72l-37.73-4.41z"
                />
                <path
                  className="st6"
                  d="M200.83 79.89c.68-5.84-3.41-11.2-9.25-11.88s-11.2 3.41-11.88 9.25c-.68 5.84 3.41 11.2 9.25 11.88 5.84.68 11.2-3.41 11.88-9.25z"
                />
                <path
                  className="st8"
                  d="M191.45 67.68c-5.84-.68-11.53 3.55-12.21 9.39-.68 5.84 3.9 10.69 9.74 11.37 5.84.68 11.53-3.55 12.21-9.39.68-5.84-3.9-10.69-9.74-11.37zm-1.51 12.98c-3.24-.38-5.55-3.28-5.16-6.52.38-3.24 3.28-5.55 6.52-5.16 3.24.38 5.55 3.28 5.16 6.52-.39 3.24-3.28 5.54-6.52 5.16z"
                />
                <circle className="st6" cx="239.84" cy="170.51" r="6.6" />
                <circle className="st6" cx="299.64" cy="178.45" r="6.6" />
                <path
                  className="st7"
                  d="M289.91 144.5c-1.86-.22-3.5 1.09-3.72 2.95l-4.41 37.73c-.22 1.86 1.09 3.5 2.95 3.72l37.73 4.41c1.86.22 3.5-1.09 3.72-2.95l4.41-37.73c.22-1.86-1.09-3.5-2.95-3.72l-37.73-4.41z"
                />
                <path
                  className="st6"
                  d="M319.19 160.46c.68-5.84-3.41-11.2-9.25-11.88s-11.2 3.41-11.88 9.25c-.68 5.84 3.41 11.2 9.25 11.88 5.84.68 11.2-3.41 11.88-9.25z"
                />
                <path
                  className="st8"
                  d="M309.81 148.25c-5.84-.68-11.53 3.55-12.21 9.39-.68 5.84 3.9 10.69 9.74 11.37 5.84.68 11.53-3.55 12.21-9.39.68-5.84-3.9-10.69-9.74-11.37zm-1.51 12.98c-3.24-.38-5.55-3.28-5.16-6.52.38-3.24 3.28-5.55 6.52-5.16 3.24.38 5.55 3.28 5.16 6.52-.38 3.24-3.28 5.54-6.52 5.16z"
                />
                <circle className="st6" cx="231.92" cy="212.63" r="6.6" />
                <circle className="st6" cx="291.72" cy="220.57" r="6.6" />
                <path
                  className="st7"
                  d="M282 186.62c-1.86-.22-3.5 1.09-3.72 2.95l-4.41 37.73c-.22 1.86 1.09 3.5 2.95 3.72l37.73 4.41c1.86.22 3.5-1.09 3.72-2.95l4.41-37.73c.22-1.86-1.09-3.5-2.95-3.72l-37.73-4.41z"
                />
                <path
                  className="st6"
                  d="M311.27 202.58c.68-5.84-3.41-11.2-9.25-11.88-5.84-.68-11.2 3.41-11.88 9.25-.68 5.84 3.41 11.2 9.25 11.88 5.85.68 11.21-3.41 11.88-9.25z"
                />
                <path
                  className="st8"
                  d="M301.89 190.37c-5.84-.68-11.53 3.55-12.21 9.39-.68 5.84 3.9 10.69 9.74 11.37 5.84.68 11.53-3.55 12.21-9.39.68-5.84-3.9-10.69-9.74-11.37zm-1.51 12.98c-3.24-.38-5.55-3.28-5.16-6.52.38-3.24 3.28-5.55 6.52-5.16 3.24.38 5.55 3.28 5.16 6.52-.39 3.24-3.29 5.54-6.52 5.16z"
                />
                <path
                  className="st4"
                  d="M246.27 169.9c-4.53-6.56-13.78-9.31-20.34-5.25s-8.06 12.69-4.2 19.12c1.67 2.52 3.86 4.63 6.49 6.14l-3.84 13.18 11.72 1.37 3.84-13.18c6.32-3.69 8.86-12.16 6.33-18.38z"
                />
                <path
                  className="st9"
                  d="M221.35 199.9c-3.41-2.71-6.25-6.15-8.25-10.23-4.27-8.33-4.03-18.19.63-26.22-6.48-6.26-14.87-8.86-22.92-5.01-10.53 5.09-14.86 18.02-9.77 28.54l27.9 54.97 2.73-18.46-9.97-10.89c-2.38-2.6-3.67-5.96-3.72-9.55-.06-4.66 2.34-9.29 6.79-11.67 2.9-1.5 6.3-1.99 9.43-1.3 4.09.93 7.55 3.73 9.27 7.44.81 1.78 1.22 3.72 1.24 5.68.03 2.82-.82 5.56-2.31 7.85 0 .01 0 .01-.01.02z"
                />
                <path
                  className="st4"
                  d="M187.49 206.5c-4.34-.51-7.57 1.78-8.06 6.01-.62 5.3 4.03 10.28 9.33 10.9s10.28-4.03 10.9-9.33c.49-4.23-1.78-7.56-6.01-8.06l-6.16-.72z"
                />
                <circle className="st0" cx="145.69" cy="57.57" r="19.89" />
                <circle className="st6" cx="145.69" cy="57.57" r="16.6" />
                <path
                  className="st7"
                  d="M144.82 81.91l-37.73-4.41c-1.86-.22-3.5-1.86-3.72-3.72l-4.41-37.73c-.22-1.86 1.09-3.5 2.95-3.72l37.73-4.41c1.86-.22 3.5 1.09 3.72 2.95l4.41 37.73c.22 1.86-1.09 3.5-2.95 3.72l-37.73 4.41z"
                />
                <path
                  className="st6"
                  d="M126.21 45.48c-.68-5.84 3.41-11.2 9.25-11.88 5.84-.68 11.2 3.41 11.88 9.25.68 5.84-3.41 11.2-9.25 11.88-5.84.68-11.2-3.41-11.88-9.25z"
                />
                <path
                  className="st8"
                  d="M135.59 57.69c5.84.68 11.53-3.55 12.21-9.39.68-5.84-3.9-10.69-9.74-11.37-5.84-.68-11.53 3.55-12.21 9.39-.68 5.84 3.9 10.69 9.74 11.37zm1.51-12.98c3.24.38 5.55 3.28 5.16 6.52-.38 3.24-3.28 5.55-6.52 5.16-3.24-.38-5.55-3.28-5.16-6.52.38-3.24 3.27-5.55 6.52-5.16z"
                />
                <path
                  className="st4"
                  d="M168.94 60.6c-.53-4.49-3.51-8.36-7.97-10.46-8.43-3.99-18.52-1.46-24.14 6.37-6.22 8.49-6.66 19.39-2.52 27.72l.01-.01c-1.37-6.22.14-12.88 4.52-17.68 4.39-4.81 10.66-7.58 17.17-6.79 2.65.33 5.15 1.21 7.38 2.55l5.55-1.7z"
                />
                <path
                  className="st4"
                  d="M146.89 28.86c-4.34-.51-7.57 1.78-8.06 6.01-.62 5.3 4.03 10.28 9.33 10.9 5.3.62 10.28-4.03 10.9-9.33.49-4.23-1.78-7.56-6.01-8.06l-6.16-.72z"
                />
                <path
                  className="st4"
                  d="M98.55 27.11c4.34-.51 7.57 1.78 8.06 6.01.62 5.3-4.03 10.28-9.33 10.9-5.3.62-10.28-4.03-10.9-9.33-.49-4.23 1.78-7.56 6.01-8.06l6.16-.72z"
                />
              </g>
            </svg>
          </div>
